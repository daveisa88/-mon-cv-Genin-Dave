    ...
    return (
        <div className="p-6 max-w-6xl mx-auto text-white relative">
            ...
            <div className="bg-gray-800 p-6 rounded-lg shadow-md mb-6">
                ...
                <div className="bg-gray-900 p-4 rounded-lg text-center border border-gray-700 mt-6">
                    ...
                    <div className="w-full h-64 bg-gray-700 flex items-center justify-center rounded-md">
                        <span className="text-gray-500"> "C:\Users\kalidave88\Downloads\Enregistrement 2025-03-28 041531.mp4" </span>
                    </div>
                </div>
            </div>
            ...
            <div className="flex flex-wrap justify-center gap-4 mt-6">
                <a href="https://github.com/daveisa88" target="_blank" rel="noopener noreferrer"
                    className="bg-pink-900 hover:bg-blue-700 text-white px-4 py-2 rounded-md shadow">🐙 GitHub</a>
                <a href="https://start.me/p/m6bmN4/bureau" target="_blank" rel="noopener noreferrer"
                    className="bg-black hover:bg-blue-600 text-white px-4 py-2 rounded-md shadow">🔗 StartMe</a>
                <a href="https://www.pearltrees.com/kalidave88" target="_blank" rel="noopener noreferrer"
                    className="bg-green-600 hover:bg-green-600 text-white px-4 py-2 rounded-md shadow">📁 Veille Informatique</a>
            </div>
        </div>
    );
};
